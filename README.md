...
- More Compatibility with Rank Cores
- And big loot of more features...
---
## Last Update
- Added CheatBreaker API
- Added Alchemist, Holiday, Phoenix and Zoot API
- Reorganized configurations yml
- Improved LunarClient API
- Fixed minor bug
---
## Needed Libraries
...
- Credits:
  ...
  - [hmRemi](https://github.com/hmRemi) [cPractice]