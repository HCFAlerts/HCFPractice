...
public enum Locale {
	...
	public Object format(Lang locale) {
		if (HCFPractice.get().getLang().get(path, locale) instanceof List)
			return HCFPractice.get().getLang().getStringList(path, locale);
		return HCFPractice.get().getLang().getString(path, locale);
	}
