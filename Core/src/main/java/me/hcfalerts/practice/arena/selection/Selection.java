package me.hcfalerts.practice.arena.selection;
...
public class Selection {
	...
	public static Selection createOrGetSelection(Player player) {
		...
		player.setMetadata(SELECTION_METADATA_KEY, new FixedMetadataValue(HCFPractice.get(), selection));
