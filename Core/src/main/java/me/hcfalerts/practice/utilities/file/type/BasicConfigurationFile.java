package me.hcfalerts.practice.utilities.file.type;
...
public class BasicConfigurationFile extends AbstractConfigurationFile {
    ...
    public void reload(){
        File file = new File(HCFPractice.get().getDataFolder(), getName() + ".yml");
        try {
    ...
    public void save() {
        File folder = HCFPractice.get().getDataFolder();
        try {
