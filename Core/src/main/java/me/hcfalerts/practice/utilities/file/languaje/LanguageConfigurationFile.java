package me.hcfalerts.practice.utilities.file.languaje;

import me.hcfalerts.practice.HCFPractice;
import me.hcfalerts.practice.utilities.chat.CC;
import me.hcfalerts.practice.utilities.file.AbstractConfigurationFile;
...
public class LanguageConfigurationFile extends AbstractConfigurationFile {
    ...
    public LanguageConfigurationFile(JavaPlugin plugin, String name, boolean overwrite) {
        ...
        for (Lang locale : Lang.values()) {
            Bukkit.getConsoleSender().sendMessage(CC.translate("&7[HCFPractice] &aLoading language file for &f" + locale.name()));
            ...
            if (plugin.getResource(path) != null) {
                ...
                Bukkit.getConsoleSender().sendMessage(CC.translate("&7[HCFPractice] &aLanguage file for &f" + locale.name() + " &asuccessfully loaded"));
            }
        }
    }
    ...
    public void reload() {
        for (Map.Entry<Lang, YamlConfiguration> entry : getConfigurations().entrySet()) {
            ...
            File file = new File(HCFPractice.get().getDataFolder(),
