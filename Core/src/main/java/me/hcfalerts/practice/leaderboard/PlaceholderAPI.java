...
public class PlaceholderAPI extends PlaceholderExpansion {
    ...
    public @NotNull String getAuthor() {
        return HCFPractice.get().getDescription().getAuthors().toString().replace("[", "").replace("]", "");
    }

    @Override
    public @NotNull String getVersion() {
        return HCFPractice.get().getDescription().getVersion();
    }

    @Override
    public String onPlaceholderRequest(Player player, @NotNull String params) {
        if (params.equals("practice_player_elo")) return String.valueOf(EloUtil.getGlobalElo(Profile.get(player.getUniqueId())));
