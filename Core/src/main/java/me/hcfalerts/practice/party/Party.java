...
public class Party {
	...
	public Party(Player player) {
		...
		if (leader.hasPermission("party.vip")){
			limit = HCFPractice.get().getMainConfig().getInteger("PARTY.VIP_LIMIT");
		} else {
			limit = HCFPractice.get().getMainConfig().getInteger("PARTY.DEFAULT_LIMIT");
		}
	...
	public static void init() {
		...
		}.runTaskTimerAsynchronously(HCFPractice.get(), 20L * 2, 20L * 2);
	}
